...
//	}
	...
	public List<BoardDTO> getDetail(String searchType_a, String searchType_b, int pageSize) {
		...
		List<BoardVO> bvoList = bdao.getBvoListByType(searchType_a, searchType_b, pageSize);
		for(BoardVO bvo : bvoList) {
			List<FileVO> fvoList = fdao.getFvoList(bvo.getBno());			
			BoardDTO bdto = new BoardDTO(bvo, fvoList);		       
	        bdtoList.add(bdto);
	...
	// searchTypeMore
	@Override
	public List<BoardDTO> getDetailMore(String searchType_a, String searchType_b, int pageSize, int page) {
		log.info(" Board List<BoardDTO> getDetail Service Impl");
		List<BoardDTO> bdtoList = new ArrayList<>();
		
		List<BoardVO> bvoList = bdao.getBvoListByTypeMore(searchType_a, searchType_b, pageSize, page);
		for(BoardVO bvo : bvoList) {
			List<FileVO> fvoList = fdao.getFvoList(bvo.getBno());			
			BoardDTO bdto = new BoardDTO(bvo, fvoList);		       
	        bdtoList.add(bdto);
	...
	@Override
	public List<BoardDTO> searchDTOListMore(String searchKeyword, int pageSize, int page) {
		log.info(" Board List<BoardDTO> searchDTOList Service Impl");
		List<BoardDTO> bdtoList = new ArrayList<>();
		
		List<BoardVO> bvoList = bdao.getBvoListByKeywordMore(searchKeyword, pageSize, page);
		for(BoardVO bvo : bvoList) {
			List<FileVO> fvoList = fdao.getFvoList(bvo.getBno());			
			BoardDTO bdto = new BoardDTO(bvo, fvoList);		       
	        bdtoList.add(bdto);
