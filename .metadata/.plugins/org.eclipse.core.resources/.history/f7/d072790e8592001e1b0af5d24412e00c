	...
	<main>
		<form action="/board/register" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
  				...
  				<input type="text" class="form-control" name="title" id="title" placeholder="ex) 1억 5,500">
			</div>
			<p id="titleError" class="error" style="color: red; display: none;">가격을 입력해주세요.</p>
			<div class="mb-3">
			  	<label for="writer" class="form-label">Writer</label>
			  	<input type="text" class="form-control" name="writer" id="writer" value="${ ses.id }" readonly="readonly">
			</div>
			<!-- 지역 선택 -->
			...
			<div class="mb-3">
			  	...
			  	<textarea class="form-control" name="content" id="content" rows="3" placeholder="ex) 아파트 50/43m2, 3/5층, 남향&#10; 엘베유 검암역 역세권 집상태 최상"></textarea>
			</div>
			...
			<div class="file-upload-container">
				<div id="thumbFileDiv">
					<input type="file" id="thumbFile" name="thumbFiles" style="display: none" required multiple>
					<button type="button" id="thumbFileTrigger">썸네일 업로드</button>
					<div id="thumbFileZone"></div>
				</div>
				...
				<div id="detailFileDiv">
					...
					<div id="detailFileZone"></div>
				</div>				
			</div>
			<button type="submit" id="regBtn" onclick="validateButton(event)" class="btn-hover color-1">등록</button>
		</form>
	</main>
	<!-- footer -->
