...
<body>
	...
	<div class="content">
        ...
        <table class="table table-striped" data-aos="fade-up">
            ...
            <tbody>
                <c:forEach items="${lvoList}" var="lvo" varStatus="loopStatus">
				    <tr class="lvoTr" style="cursor:pointer;">
				        ...
				        <td>${lvo.date }</td>
				        <!-- 데이터 속성 추가 -->
				        <td data-lno="${lvo.lno}" data-id="${lvo.id}">
				            <button class="openModalButton">열기</button>
				        </td>
				    </tr>
                    <!-- Modal -->
					<div class="confirmationModal" id="confirmationModal_${loopStatus.index}">
						<div id="modalContent">
						    ...
						    <button class="cancelAction">취소</button>
						</div>				    
					</div>
                </c:forEach>
            </tbody>
